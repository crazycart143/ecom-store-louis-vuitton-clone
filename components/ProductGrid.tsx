      ...
      <div className="py-24 px-6 md:px-12 bg-white">
        <div className="container mx-auto">
          <header className="mb-16 text-center">
            ...
            <div className="h-10 bg-zinc-100 w-1/3 mx-auto rounded-sm animate-pulse" />
          </header>
          <ProductGridSkeleton />
        </div>
      </div>
      ...
      <div className="container mx-auto">
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-zinc-500 font-light italic">No creations found in the database. Please seed the database.</p>
          </div>
        ) : (
                ...
                >
                  <Link href={`/product/${product.id}`} className="block">
                    ...
                    <div className="space-y-1 text-center sm:text-left">
                      ...
                      <p className="text-[11px] text-zinc-500 tracking-widest font-luxury">
